...
<div class="cgu">
    ...
    <p>Les présentes « conditions générales d'utilisation » ont pour objet l'encadrement juridique des modalités de mise à disposition des services du site CVtech par ©Hybrid Games et leur utilisation par « l'Utilisateur ».</p>
    ...
    <ul>
        ...
        <li>CVte par ©Hybrid Games se réserve le droit de modifier unilatéralement et à tout moment le contenu des présentes conditions générales d'utilisation.</li>
    </ul>
    <div class="container-fluid fonc">
        <div class="container">
    ...
    <p>L'édition du site CVtech par ©Hybrid Games est assurée par la Société ©Hybrid Games SARL au capital de 1000 € dont le siège social est situé à Washington DC.
<p>Le Directeur de la publication est Monsieur Yohann Carella.</p>
<p>Éventuellement :</p>
<ul>
    <li>©Hybrid Games est une société du groupe ©Hybrid Games SARL au capital de 1000 € dont le siège social est situé à Washington DC.</li>
    <li>L'hébergeur du site CVtech par ©Hybrid Games est la Société ©Hybrid Games SARL au capital de 1000 € dont le siège social est situé à Washington DC.</li>
</ul>
...
<p>Tout événement dû à un cas de force majeure ayant pour conséquence un dysfonctionnement du réseau ou du serveur n'engage pas la responsabilité de CVtech par ©Hybrid Games.</p>
...
<p>L'Utilisateur a la possibilité de contacter le site par messagerie électronique à l’adresse contact@b4rb4m.fr.</p>
...
<p>Le site assure à l'Utilisateur une collecte et un traitement d'informations personnelles dans le respect de la vie privée conformément à la loi n°78-17 du 6 janvier 1978 relative à l'informatique, aux fichiers et aux libertés. Le site est déclaré à la CNIL sous le numéro 42424242.</p>
...
<ul>
    ...
    <li>par mail à request@hybrid-games.fr ;</li>
    <li>par voie postale à Washington DC ;</li>
</ul>
...
<p>De nombreux liens hypertextes sortants sont présents sur le site, cependant les pages web où mènent ces liens n'engagent en rien la responsabilité de CVtek par ©Hybrid Games qui n'a pas le contrôle de ces liens.</p>
...
<p>La législation française s'applique au présent contrat. En cas d'absence de résolution amiable d'un litige né entre les parties, seuls les tribunaux du ressort de la Cour d'appel de Comté-De-L'Or sont compétents.</p>
...
<p>Le site permet aux membres de publier des œuvres personnelles.</p>
